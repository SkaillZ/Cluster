    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (musicSrv != null) {
            ...
            if (songList != null) {
                ...
                txtTitle.setText(songList.get(song_nr).getTitle());
                txtArtist.setText(songList.get(song_nr).getArtist());
                txtAlbum.setText(songList.get(song_nr).getAlbum());
